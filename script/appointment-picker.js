...
(function (root, factory) {
	...
	var AppointmentPicker = function(el, options) {
		this.options = {
			...
			title: '<input type="date" id="date-picker" placeholder="14.05.2022">', // Title
	...
	function _onselect(e) {
        ...
        if (e.target.type === 'date'){
            this.displayDate = e.target.value;
        }
		if ((!e.target.value) || (e.target.type === 'date')) return;
        // if (datePicker.value !== ''){
        //     console.log('change');
        //     this.picker = _build(_this);
        //     this.disabledArr = ['3:00 pm'];
        //     this.isOpen = true;
        //     this.render();
        //     this.picker.addEventListener('click', this.selectionEventFn);
        //     this.picker.addEventListener('keyup', this.keyEventFn);
        ...
        //     _dispatchEvent(this.el, 'open', this.time, this.displayTime);
        // }
        this.displayDate = ' ' + datePicker.value;
	...
	AppointmentPicker.prototype.setTime = function(value) {
		...
		this.render();
		this.el.value = this.displayTime + this.displayDate;
	};
